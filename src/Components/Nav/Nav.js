...
export const Nav = () => {
    ...
    return (
      <div className="px-4 py-3 bg-primary text-white mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 shadow-lg md:rounded-lg my-5">
        <div className="relative flex items-center justify-between text-white">
          ...
          <div className="lg:hidden">
            ...
            {isMenuOpen && (
              <div className="absolute z-50 top-0 left-0 w-full bg-primary">
                <div className="p-5 border rounded shadow-sm bg-primary">
